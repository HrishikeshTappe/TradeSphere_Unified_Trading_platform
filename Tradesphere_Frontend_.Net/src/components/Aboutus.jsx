  ...
  const teamMembers = [
    {
      ...
      bio: "Founder of TradeSphere, leading vision, strategy, and growth with a strong focus on transparency and user-first design."
    },
    {
      name: "Hrishikesh Tappe",
      role: "Chief Technology Officer",
      img: "src/assets/hrushikesh.jpeg",
      bio: "Heads engineering and architecture, ensuring scalable, secure, and high-performance systems."
    },
    {
      name: "Sachin Waghchaure",
      role: "Chief Operations Officer",
      img: "src/assets/sachin.jpeg",
      bio: "Oversees daily operations, process optimization, and cross-team execution."
    },
    {
      name: "Nikhil Shingare",
      role: "Head of Marketing",
      img: "src/assets/nikhil.jpeg",
      bio: "Leads marketing strategy, branding, and customer acquisition initiatives."
    },
    {
      name: "Yukta Jadhav",
      role: "Lead Product Manager",
      img: "src/assets/yukta.jpeg",
      bio: "Drives product vision, roadmap planning, and user-centric feature development."
    }
  ];
